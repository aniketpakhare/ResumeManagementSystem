# Generated by Django 3.0.2 on 2021-01-29 18:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('itype', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rmsapp.IndustryModel')),
                ('person', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='rmsapp.RegistrationModel')),
            ],
        ),
    ]
